    ...
    try {
        ...
        try {
            ...
            try {
                ...
                console.log(`[INFO] Wallet balance after redeem: ${balanceAfterRedeem.toFixed(6)} USDC`);
                ...
                console.log(`[INFO] ✅ Logged balance to pnl.log`);
            } catch (balanceError) {
                console.log(`[WARNING] Failed to get balance after redeem: ${balanceError instanceof Error ? balanceError.message : String(balanceError)}`);
            ...
            console.log(`[WARNING] Failed to log balance: ${balanceLogError instanceof Error ? balanceLogError.message : String(balanceLogError)}`);
        }
